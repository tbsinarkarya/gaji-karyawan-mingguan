...
const EmployeeCard: React.FC<{
  ...
  // fallback aman: kalau string kosong atau undefined → pakai default.png
  const imageSrc =
    employee.image_url && employee.image_url.trim() !== ''
      ? employee.image_url
      : '/default.png';
      ...
      <div className="flex-1">
        ...
        <div className="mt-1">
          <p className="text-md font-semibold text-brand-secondary">
            {formatCurrency(employee.daily_rate)} / hari
          </p>
          <p className="text-sm text-slate-500">
            Tunjangan: {formatCurrency(employee.weekly_allowance)} / minggu
          </p>
        </div>
      </div>
          ...
          {employees.length > 0 ? (
            ...
            <div className="text-center py-10 px-4 bg-slate-50 rounded-lg">
              ...
              <p className="text-slate-400 text-sm">
                Klik 'Tambah' untuk menambahkan karyawan baru.
              </p>
            </div>
          )}
        </div>
